...
export default function Desktopcard1() {
          ...
          >
            ...
            <li style={{ listStyleType: "none" }}>
              ...
              <p className="d-inline">
                The world’s best all-in-one computer, is now supercharged by the
                M3 chip. With a stunning 24-inch display that gives you all the
                space you need and an iconic design that livens up any space,
                iMac is perfect for work and play. <br />
                •Apple M3 8-Core CPU <br />
                •24GB Unified RAM| 2TB SSD <br />
                •10-Core GPU | 16-Core Neural Engine <br />
                •24" 4480 x 2520 Retina Display <br />
              </p>
            </li>
            <li className="mt-2 mx-3 fw-bolder" style={{listStyleType:"none",color:"rgb(0, 179, 255)",fontSize:"1.1rem"}}>${finalPrice}</li>
